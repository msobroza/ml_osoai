...
class VanillaDataEmbeddingGenerator(object):

    def __init__(self, x, y, y_target, batch_size, shuffle=True, seed=1234):
        """
        Args:
          x: ndarray
          y: 2darray
    ...
    def generate(self, max_iteration=None):
        ...
        while True:
            ...
            yield self.x[batch_idxes], self.y_target[batch_idxes]
...
class BalancedDataEmbeddingGenerator(object):
    """Balanced data generator. Each mini-batch is balanced with approximately 
    the same number of samples from each class. 
    """
    
    def __init__(self, x, y, y_target, batch_size, shuffle=True, seed=1234, verbose=0):
        """
        Args:
          x: ndarray
          y: 2darray
